...
public class FastJsonNotification implements Bean {
    ...
    private static final long serialVersionUID = 4804197443375210178L;
    ...
    public FastJsonNotification(
            FastJsonLongIdKey key, FastJsonStringIdKey userKey, String remark, Date notifiedDate, Date readDate,
            boolean readFlag, String subject, String body
    ) {
        this.key = key;
