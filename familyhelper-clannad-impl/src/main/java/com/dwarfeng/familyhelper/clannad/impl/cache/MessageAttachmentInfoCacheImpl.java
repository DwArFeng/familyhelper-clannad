...
import com.dwarfeng.familyhelper.clannad.sdk.bean.entity.FastJsonMessageAttachmentInfo;
...
@Repository
public class MessageAttachmentInfoCacheImpl implements MessageAttachmentInfoCache {

    private final RedisBatchBaseCache<LongIdKey, MessageAttachmentInfo, FastJsonMessageAttachmentInfo> batchBaseCache;

    public MessageAttachmentInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, MessageAttachmentInfo, FastJsonMessageAttachmentInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public MessageAttachmentInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(MessageAttachmentInfo value, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<MessageAttachmentInfo> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(List<MessageAttachmentInfo> entities, long timeout) throws CacheException {
