...
public class CertificateFileInfoCrudOperation implements BatchCrudOperation<LongIdKey, CertificateFileInfo> {
    ...
    public void delete(LongIdKey key) throws Exception {
        // 如果存在证书文件，则删除证书文件。
        if (ftpHandler.existsFile(new String[]{FtpConstants.PATH_CERTIFICATE_FILE}, getFileName(key))) {
            ftpHandler.deleteFile(new String[]{FtpConstants.PATH_CERTIFICATE_FILE}, getFileName(key));
        }
