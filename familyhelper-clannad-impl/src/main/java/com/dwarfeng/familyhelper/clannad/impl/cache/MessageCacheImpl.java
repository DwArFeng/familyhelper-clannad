...
public class MessageCacheImpl implements MessageCache {
    ...
    private final RedisBatchBaseCache<LongIdKey, Message, FastJsonMessage> batchBaseCache;

    public MessageCacheImpl(RedisBatchBaseCache<LongIdKey, Message, FastJsonMessage> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Message get(LongIdKey key) throws CacheException {
    ...
    public void push(Message value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Message> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<Message> entities, long timeout) throws CacheException {
