...
@Component
public class NotifyMetaPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case NotifyMetaMaintainService.CHILD_FOR_NOTIFY_SETTING:
                childForNotifySetting(detachedCriteria, objects);
                break;
            case NotifyMetaMaintainService.CHILD_FOR_NOTIFY_TOPIC:
                childForNotifyTopic(detachedCriteria, objects);
                break;
            case NotifyMetaMaintainService.CHILD_FOR_USER:
